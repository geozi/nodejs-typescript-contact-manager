/**
 * Contact update integration tests.
 */
...
import { updateContactRecord } from "../../src/presentation/apis/v1/controllers/contact.controller";
...
describe.only("Contact update integration tests", () => {
  ...
  describe("validation-oriented", () => {
    describe("bad requests (400)", () => {
      beforeEach(() => {
        sinon.replace(contactService, "updateContactRecord", sinon.fake());
        res = {
  ...
  describe("promise-oriented", () => {
    ...
    it("server error (500)", async () => {
      ...
      testLogger.info(`contactUpdate -> 'server error (500)' test OK`);
    });
    ...
    it("not found (404)", async () => {
      ...
      testLogger.info(`contactUpdate -> 'not found (404)' test OK`);
    });
  });
});
